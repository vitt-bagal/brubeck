...
// Find the index of a tag delimiter. If there is no tag delimiter, returns the length of the string
...
const struct brubeck_tag_set *brubeck_get_tag_set(struct brubeck_tags_t*, const char* key_str, uint16_t key_len);
